## <span style="color:#ff0000;">Note:Satasupe-FoundryVTT (on and after v0.6.x) isn't supported by FoundryVTT v0.8.x.<br>For FVTT v0.8.x, use Satasupe-FoundryVTT v0.5.x</span>
